...
_.first = function(array, number) {   // >= 0
...
*/
_.reject = function(array, filter) {
    let newArray = [];
    for (let i = 0; i < array.length; i++) {
...
*/
_.partition = function(array, action) {            //loop through array. if the function passed to array returns true, push
