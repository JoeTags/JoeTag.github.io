...
function greeter(hour) {
    ...
    // 1st: if: hour is greater than or equal to 0 and (&&) less than 12//
    if (hour >= 0 && hour <= 11) {
        console.log("Good Morning!");
        //2nd: else if: hour is greater than or equal to 12 and less than 16// 
    } else if (hour >= 12 && hour <= 16) {
        console.log("Good Afternoon!");
        //3rd conditional: repeat the same logic from the first two//
